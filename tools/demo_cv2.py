...
DATASETS= {'pascal_voc': ('voc_2007_trainval',),'pascal_voc_0712': ('voc_2007_trainval+voc_2012_trainval',),'pascal_coco':('coco_2014_train+coco_2014_valminusminival',)}
...
def vis_detections(im, class_name, dets, thresh=0.5):
    ...
    for i in inds:
        ...
        cv2.putText(im, '{:s} {:.3f}'.format(str(label), score), (int(x1), int(y1+8)), font, 0.5, (r, g, b), 2)
        '''
        ax.add_patch(
...
def demo(sess, net, image_name):
    ...
    save_path = os.path.join(cfg.DATA_DIR, 'result', image_name)
...
def parse_args():
    ...
    parser.add_argument('--dataset', dest='dataset', help='Trained dataset [pascal_voc pascal_voc_0712, pascal_coco]',
...
if __name__ == '__main__':
    ...
    tfmodel = os.path.join('output', demonet, 'default', NETS[demonet][0])
    ...
    im_names = ['0_Parade_marchingband_1_412.jpg', '0_Parade_marchingband_1_657.jpg','00000001.jpg', '00000003.jpg',
                '00000013.jpg', '00000138.jpg', '15673749081_767a7fa63a_k.jpg']
